package com.bigdata.kafka.util;
...
/**
 * Created by HuShiwei on 2016/7/27 0027.
 */
...
///////////////////////////////////////////
    /**
     * 获取配置的字符串值,不会将值写入xml文件，而是将设置的k v放在内存
     * @param configXPath  配置项路径
     * @return
     *
     */
...
//				System.out.println(path);
            ...
            if (!path.contains("[")&&(paths.length>parts))
            {//不包含更深的子节点和属性path
