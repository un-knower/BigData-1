...
object RDDToDataSet {
  def main(args: Array[String]) {
    ...
    val rdd = sparkContext.textFile("Spark22/src/main/resources/data.txt")
    val ds = sparkSession.read.text("Spark22/src/main/resources/data.txt").as[String]
